<template>
  <div class="container-style">
    ...
    <div class="background-style">
      <div class="back-text">
        <h1>Python高阶实战项目----智能家居</h1>
        <p>Python+Linux+树莓派，让你领略最前沿的智能领域</p>
      </div>
      <div class="fixed_bg">
        <div class="con">
          <div>
        ...
        <div class="content-intro">
          <div class="intro-text">
            ...
            <div class="intro-text-content">
              <div class="introP">
                <h1>Python高阶实战项目----智能家居</h1>
                <p>本课程涉及物联网相关知识，在人工智能的基础上，通过Python、Linux和树莓派相结合，搭建一个可控颜色照明灯的智能家居系统</p>
              </div>
              <div class="line"></div>
            </div>
          </div>
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class8_bg1.jpg");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class8_bg2.jpg");
