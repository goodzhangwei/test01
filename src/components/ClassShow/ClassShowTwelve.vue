<template>
  <div class="container-style">
    ...
    <div class="background-style">
      <div class="back-text">
        <h1>Python人工智能编程公益课堂</h1>
        <p>
          本次公益课堂由临沂市科技馆联合“青程在线”青少年科技编程平台，推出的人工智能公益体验课程。
        </p>
        <div class="btns2" @click="gotoPy" v-if="stateCode === -1">
          <span>立即报名</span>
        </div>
        <div class="btns2" @click="gotoInfo" v-else>
          <span>已报名</span>
        </div>
      </div>
      <!--<div class="fixed_bg">-->
    ...
    <div v-show="tagsShow === '课程介绍' ">
          ...
          <div class="intro-text">
            <div class="iconbofang">
              <div class="iconbofang-text">
                <i class="iconfont ymq-iconbofang" @click="gotoPy2"></i>
            ...
            <div class="intro-text-content">
              <div class="introP">
                <h1>Python人工智能编程公益课堂</h1>
                <p>2018年1月，教育部颁发的《新课标》指出：信息技术将从兴趣课程变为必修课程，提出人工智能要进入基础教育课堂。</p>
                <p>编程是实践驱动的一种很好的提升专注力、培养逻辑思维能力、提升孩子创新能力的有效方式，学习编程大有益处。</p>
                <p>21世纪是信息时代，科技是唯一链接世界的桥梁，学习编程正是与这种可期未来的关键沟通方式。启迪科技兴趣，触发AI编程，让孩子成为未来的主人。</p>
              </div>
              <div class="line"></div>
            </div>
          </div>
      ...
      <div class="detailCont">
        <div class="detail-content">
          <div class="detail-head-text">
            <h1>Python人工智能编程公益课堂</h1>
            <h4>通过Python兴趣编程，提升学生对AI认知与体验，在Python编程实践中提高专注力和逻辑意识，为科技特长形成积淀第一步。</h4>
          </div>
          <div class="detail-left">
          </div>
          <div class="detail-cards">
            <div class="detail-cards-content">
              <h3>课程特色：</h3>
              <h4>1、内容特色：</h4>
              <p class="detail-card-right-text">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;可爱的小海龟画出想要的图形、自主控制个人制作的风扇、驱动自动识别障碍物的汽车、按颜色将物品进行自动分拣机器人，，，等等，这些都可以通过Python编程实现。AI已来，动起手来，创造出属于自己的惊喜！
              </p>
              <h4>2、授课特点：</h4>
              <p class="detail-card-right-text">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PBL实践模式：PBL（Problem-Based Learning method基于项目的学习方法）的项目实践式学习模式，突破单纯知识点的学习和记忆，重点通过围绕解决项目问题的实践方式，引导学生通过生活化的问题进行科技实践，愿意学、有兴趣深入。
              </p>
              <p class="detail-card-right-text">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交流启发式：教学中老师会根据学生学习特点和行为，针对性与其进行互动，引导其发现科技编程的乐趣，使其获得以计算机解决实际问题的成就感。
              </p>
            </div>
            <!--<div>-->
      ...
      <div class="section1">
        <div class="section-content">
          ...
          <div class="section-detail">
            <!--<img src="../../assets/zhishitu2.png">-->
            <!--<div>-->
              <!--<div class="section-left">-->
                <!--<img class="section-left-img" src="../../assets/section3-1.png"/>-->
                <!--<div class="section-left-text">-->
                  <!--本期公益课堂为5次课，包括AI前沿、编程实践、学习指导、个性化问题解答、总结交流等环节。-->
                <!--</div>-->
              <!--</div>-->
              <!--<div class="section-right">-->
                <!--<img class="section-left-img" src="../../assets/section3-1.png"/>-->
                <!--<div class="section-left-text">-->
                  <!--本次学习对Python的知识体系梳理、了解课程特点及与实践的结合。-->
                <!--</div>-->
              <!--</div>-->
            ...
            <div class="table-content">
              <table border="1" class="table-detail">
                <tr>
                  <td class="td-style-left td-style" align="center">课次</td>
                  <td class="td-style" align="center">内容</td>
                </tr>
                <tr>
                  <td class="td-style-left td-style" align="center">课次1</td>
                  <td class="td-style">
                    <div>
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;开班启动人工智能之旅，并为Python搭建好可靠的环境
                      </p>
                    </div>
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">课次2</td>
                  <td class="td-style">
                    <div>
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;自动躲避障碍物机器人
                      ...
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在搭建好机器人后，编写代码实现机器人自动识别障碍物，并实现前进后退或转弯等动作。
                      </p>
                    </div>
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">课次3</td>
                  <td class="td-style">
                    <div>
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;智能识别颜色分类机器人
                      ...
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在搭建好机器人后，编写代码实现机器人能识别‘红’、‘绿’、‘黄’、‘蓝’四种颜色，并根据物品的颜色将物品分类。
                      </p>
                    </div>
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">课次4</td>
                  <td class="td-style">
                    <div>
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;小海龟画画
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">课次5</td>
                  <td class="td-style">
                    <div>
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;智能取物机器人
            ...
            <div class="table-content">
              <table border="1" class="table-detail">
                <tr>
                  <td class="td-style-left td-style" align="center">项目&案例</td>
                  <td class="td-style" align="center">介绍</td>
                </tr>
                <tr>
                  <td class="td-style-left td-style" align="center">灵动机器人-自动躲避障碍物</td>
                  <td class="td-style">
                    <div>
                      <div class="td-img">
                        <img src="../../assets/tw_table1.png" class="td-img-three">
                      </div>
                    </div>
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">“火眼金融”智能辨色机器人</td>
                  <td class="td-style">
                    <div>
                      <div class="td-img">
                        <img src="../../assets/tw_table2.png" class="td-img-three">
                      </div>
                    </div>
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">智能取放机器人</td>
                  <td class="td-style">
                    <div>
                      <div class="td-img">
                        <img src="../../assets/tw_table3.png" class="td-img-three">
                      </div>
                    </div>
                ...
                <tr>
                  <td class="td-style-left td-style" align="center">海龟画图</td>
                  <td class="td-style">
                    <div>
                      <p>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;小海龟是一个绘画大师，同学们可以让小海龟帮助自己画出，自己想要的图片。编程实践使画图效果更饱满、色彩更丰富、激发进一步探索兴趣。
                      </p>
                      <div class="td-img">
                        <img src="../../assets/tw_table4.png" class="td-img-three">
                      </div>
                    </div>
      ...
      <div class="section4">
        <div class="section-content">
          <h1>课程延伸</h1>
          <p class="section4_p">
            “青程在线”科技编程平台提供针对不同层次的学生，提供适应其学习需求的Python编程课程，比如贪吃蛇小游戏。
          </p>
          <div class="section4_img">
            <img src="../../assets/tw_table5.png">
          </div>
          <p class="section4_p">
            “青程在线”科技编程平台还将与中科院ACME大赛等对接，为学有所成的同学提供参加大赛展示实力，冲击获奖的机会。
          </p>
        </div>
      </div>
      <div class="section3">
            ...
            <div class="section3-right-card">
              <div class="box2">
                ...
                <div class="box-content2">
                  ...
                  <br>
                  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;课程适应性强：考虑到了不同老师的基础差异， Python课程从基础讲起，梳理好重点内容，既保证了初步入门老师的需求，同时也增加了更多实践，满足具有一定基础老师的提升。
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="eval-left" v-for="(item, index) in list" :key="index">
          ...
          <div class="eval-right-text">
            ...
            <div class="line-left" v-for="(item2, index2) in item.children" :key="index2">
              ...
              <span class="sikan" style="font-size: 12px" v-if="index2 === 0 && index === 0" @click="gotoPy2">试看</span>
            </div>
          </div>
        </div>
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class_tw_img.png");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class_tw_img2.jpg");
  ...
  .detail-cards-content h3 {
    color: #fff;
    font-size: 28px;
  }
  .detail-cards-content h4 {
    color: #fff;
    font-size: 20px;
    margin-top: 30px;
  }
  .detail-card-right-text {
    color: #fff;
    font-size: 20px;
    margin-bottom: 20px;
  }
  ...
  .section4 {
    width: 100%;
    height: 650px;
    background-image: url("../../assets/class_tw_img3.png");
    background-size: cover;
    background-position: center;
  }
  .section4_p {
  ...
  .section3 {
    width: 100%;
    height: 600px;
    background-image: url("../../assets/class_tw_img4.png");
    background-size: cover;
    background-position: center;
  }
  .section3-content {
