<template>
  <div class="container-style">
    ...
    <div class="background-style">
      <div class="back-text">
        <h1>Python系列课程——数据爬虫专题</h1>
        <p>从零起步，系统培养爬虫工程师，步步为营打造爬虫工程师的核心竞争力</p>
      </div>
      <div class="fixed_bg">
        <div class="con">
          <div>
        ...
        <div class="content-intro">
          <div class="intro-text">
            ...
            <div class="intro-text-content">
              <div class="introP">
                <h1>Python系列课程——数据爬虫专题</h1>
                <p>这是一门专门为爬虫初学者打造的教程，从零起步的系统化教程，课程内容从理论到实践，一层一层深入讲解，尤其是课程实战环节：一步一步带你进行多场景项目实践 ，让你能够举一反三从容面对以后的数据抓取问题</p>
              </div>
              <div class="line"></div>
            </div>
          </div>
    ...
    methods: {
      ...
      gotoPy() {
        this.$router.push({
          path: '/videoclass',
          query: {
            class_id: '297e7c7c62b8aa9d0162b8ab56ba0001'
          }
        })
      },
      getClassList() {
        var url = 'https://www.zhongkeruitong.top/towerImg/cms/course/courseview/297e7c7c62b8aa9d0162b8ab56ba0001/' + localStorage.getItem('name')
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class6_bg1.png");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class6_bg2.jpg");
