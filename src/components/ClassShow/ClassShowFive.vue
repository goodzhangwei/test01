<template>
  <div class="container-style">
    ...
    <div class="background-style">
      <div class="back-text">
        <h1>Python系列课程——人脸识别专题</h1>
        <p>人脸识别入门级课程，让你领略python如何进行人脸识别</p>
      </div>
      <div class="fixed_bg">
        <div class="con">
          <div>
        ...
        <div class="content-intro">
          <div class="intro-text">
            ...
            <div class="intro-text-content">
              <div class="introP">
                <h1>Python系列课程——人脸识别专题</h1>
                <p>人脸识别，是基于人的脸部特征信息进行身份识别的一种生物识别技术。本课程用python语言为基础，通过几个简单的实践案例实现人脸识别的功能，让同学们能对这个领域有一个初步的认知。</p>
              </div>
              <div class="line"></div>
            </div>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getClassList() {
        var url = 'https://www.zhongkeruitong.top/towerImg/cms/course/courseview/ff80808172a7363b0172a7ad263100b2/' + localStorage.getItem('name')
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class5_bg1.jpg");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class5_bg3.jpg");
