<template>
    <div class="container-style">
      ...
      <div class="background-style">
        <div class="back-text">
         <h1>Python入门的必选之课 实战项目驱动 由浅入深 循序渐进</h1>
         <p>为编程小白倾心打造</p>
        </div>
        <div class="fixed_bg">
          <div class="con">
          ...
          <div class="content-intro">
            <div class="intro-text">
              ...
              <div class="intro-text-content">
                <div class="introP">
                  <h1>Python程序设计与计算思维（入门版）</h1>
                  <p>针对编程初学者打造的系列课程，与以往的Python教学大不相同。本课程专注于用实践推动知识点的讲解，几十种有趣的python案例，让学编程不在枯燥！</p>
                </div>
                <div class="line"></div>
              </div>
            </div>
        ...
        <div class="detailCont">
          <div class="detail-content">
            <div class="detail-head-text">
              <h1>未来是人工智能的时代！这是一门专为编程小白打造的入门课</h1>
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class_bg1.jpg");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class_bg2.jpg");
