<template>
  <div class="container-style">
    ...
    <div class="background-style">
      <div class="back-text">
        <h1>Python系列课程——数据分析专题</h1>
        <p>基于Python3，全程以真实案例驱动，带你科学系统的转行数据分析与挖掘建模领域</p>
      </div>
      <div class="fixed_bg">
        <div class="con">
          <div>
        ...
        <div class="content-intro">
          <div class="intro-text">
            ...
            <div class="intro-text-content">
              <div class="introP">
                <h1>Python系列课程——数据分析专题</h1>
                <p>数据分析太火爆，怎奈机器学习又太难懂。本课程带你轻松玩转数据分析与机器学习经典算法。使用数据领域最主流语言Python及其分析与建模库基于真实数据集实例演示如何应用机器学习算法解决实际问题。</p>
              </div>
              <div class="line"></div>
            </div>
          </div>
    ...
    methods: {
      ...
      gotoPy() {
        this.$router.push({
          path: '/videoclass',
          query: {
            class_id: 'ff80808172bc85820172f533ae7b0817'
          }
        })
      },
      getClassList() {
        var url = 'https://www.zhongkeruitong.top/towerImg/cms/course/courseview/ff80808172bc85820172f533ae7b0817/' + localStorage.getItem('name')
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class7_bg1.jpg");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class7_bg2.jpg");
  ...
  .detailCont {
    ...
    margin-top: 70px;
    width: 100%;
    background-image: url("../../assets/class5_bg4.png");
    background-size: cover;
    background-position: center;
  }
  .detail-content {
  ...
  .detail-left {
    width: 600px;
    height: 517px;
    background-image: url("../../assets/class5_bg5.png");
    background-size: cover;
    background-position: center;
    position: absolute;
    top: 160px;
