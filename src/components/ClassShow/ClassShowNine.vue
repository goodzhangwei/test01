<template>
  <div class="container-style">
    ...
    <div class="background-style">
      <div class="back-text">
        <h1>Python高阶实战项目----算法博弈挑战赛</h1>
        <p>针对大赛项目专项培训，深入剖析赛项规则</p>
      </div>
      <div class="fixed_bg">
        <div class="con">
          <div>
        ...
        <div class="content-intro">
          <div class="intro-text">
            ...
            <div class="intro-text-content">
              <div class="introP">
                <h1>Python高阶实战项目----算法博弈挑战赛</h1>
                <p>本课程涉针对中科院ACME未来科技挑战赛贪吃蛇博弈算法挑战赛的赛项进行深入解读剖析，让参赛选手能够第一时间弄明白赛项规则，以及参赛思路等。</p>
              </div>
              <div class="line"></div>
            </div>
          </div>
    ...
    methods: {
      ...
      gotoPy() {
        this.$router.push({
          path: '/videoclass',
          query: {
            class_id: 'ff808081728e1033017292929a790025'
          }
        })
      },
      gotoPay() {
      ...
      getClassList() {
        var url = 'https://www.zhongkeruitong.top/towerImg/cms/course/courseview/ff808081728e1033017292929a790025/' + localStorage.getItem('name')
...
<style scoped>
  ...
  .background-style {
    background-image: url("../../assets/class9_bg1.png");
    height: 500px;
  ...
  .content-intro {
    height: 550px;
    margin-top: 50px;
    background-image: url("../../assets/class9_bg2.png");
  ...
  .detailCont {
    ...
    margin-top: 70px;
    width: 100%;
    background-image: url("../../assets/class9_bg3.png");
    background-size: cover;
    background-position: center;
  }
  .detail-content {
